...
passport.use(new googleStrategy({
    clientID: process.env.SOCIALITE_GOOGLE_CLIENT_ID ,
    clientSecret: process.env.SOCIALITE_GOOGLE_CLIENT_SECRET,
    callbackURL: process.env.SOCIALITE_GOOGLE_CALLBACK_URL,
